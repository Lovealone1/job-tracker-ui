...
export function ResumeEditor({ initialData, onSave }: ResumeEditorProps) {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-72px)] overflow-hidden bg-background">
            {/* Top Toolbar */}
            <div className="h-14 border-b border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-950/50 backdrop-blur-md flex items-center justify-between px-6 shrink-0">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-64 border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50 flex flex-col shrink-0">
                ...
                {/* Right: Live Preview */}
                <div className="w-[500px] border-l border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900/30 overflow-y-auto shrink-0 select-none">
                    <div className="p-8">
                        {viewMode === 'real' ? (
